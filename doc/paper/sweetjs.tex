...
\begin{lemma}[\label{lem:readFunctionDeclaration}Parse Equivalence for FunctionDeclaration]\mbox{}
...
\begin{lemma}[\label{lem:readStatement}Parse Equivalence for Statement]\mbox{}
...
\begin{lemma}[\label{lem:readIfStatement}Parse Equivalence for IfStatement]\mbox{}
...
\begin{lemma}[\label{lem:readLabelledStatement}Parse Equivalence for LabelledStatement]\mbox{}
...
\begin{lemma}[\label{lem:readReturnStatement}Parse Equivalence for ReturnStatement]\mbox{}
...
\begin{lemma}[\label{lem:readBlock}Parse Equivalence for Block]\mbox{}
...
\begin{lemma}[\label{lem:readStatementList}Parse Equivalence for StatementList]\mbox{}
...
\begin{lemma}[\label{lem:readExpressionStatement}Parse Equivalence for
  ExpressionStatement]\mbox{}
...
\begin{lemma}[\label{lem:readAssignmentExpression}Parse Equivalence
  for  AssignmentExpression]\mbox{}
...
\begin{lemma}[\label{lem:readBinaryExpression}Parse Equivalence for BinaryExpression]\mbox{}
...
\begin{lemma}[\label{lem:readCallExpression}Parse Equivalence for CallExpression]\mbox{}
...
\begin{lemma}[\label{lem:readMemberExpression}Parse Equivalence for MemberExpression]\mbox{}
...
\begin{lemma}[\label{lem:readPrimaryExpression}Parse Equivalence for PrimaryExpression]\mbox{}
...
\begin{lemma}[\label{lem:readStatementPrefix}Statement Prefix]\mbox{}
