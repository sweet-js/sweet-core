...
\begin{lemma}[\label{lem:readPrimaryExpression}Read PrimaryExpression]\mbox{}
  
  \( \forall s. s \in \gprod{PrimaryExpression}{e} \Leftrightarrow 
...
\begin{proof}
  ...
  \item \( s \in \gprod{PrimaryExpression}{\rett} ::= \re \). Then \( s
    = \re \) and \( \readfn{\re}{p}{b} \in
    \gprod{PrimaryExpression'}{\rett} \) directly.
    \textbf{TODO: prefix matters here}
