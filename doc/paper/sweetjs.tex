...
\abstract{ Lisp and Scheme have demonstrated the power of macros to
  ...
  and parser. This separated lexer and parser allows us to implement
...
While the algorithm we present in this paper for resolving ambiguities
in the reader is specific to JavaScript, the technique can be applied
to other languages that have ambiguities in their grammar. For
example, the symbol \verb!<! in Rust~\cite{rustlang} is ambiguous and
our technique here could be applied for Rust and languages like it. We
expand on this point in Section~\ref{sec:discussion}.
