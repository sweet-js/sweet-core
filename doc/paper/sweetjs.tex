...
For example, in Rust~\cite{rustlang} the token \lstinline!<! is
ambiguous---it can mean either the less than operator or the start of
a template---and this ambiguity is resolved by intertwining the lexer
and parser.
...
basic techniques could be applied for other languages such as Rust.
