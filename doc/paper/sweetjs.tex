...
\begin{lemma}[\label{lem:readIfStmt}Parse Equivalence for IfStmt]\mbox{}
...
\begin{lemma}[\label{lem:readLabelledStmt}Parse Equivalence for LabelledStmt]\mbox{}
...
\begin{lemma}[\label{lem:readReturnStmt}Parse Equivalence for ReturnStmt]\mbox{}
...
\begin{lemma}[\label{lem:readExprStmt}Parse Equivalence for
  ExprStmt]\mbox{}
...
\begin{lemma}[\label{lem:readAssignExpr}Parse Equivalence
  for  AssignExpr]\mbox{}
