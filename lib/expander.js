    ...
    function enforest$212(toks$350, env$351) {
        ...
        function step$352(head$353, rest$354) {
            ...
            if (head$353.hasPrototype(TermTree$178)) {
                ...
                if ((head$353.token.type === parser$88.Token.Identifier || head$353.token.type === parser$88.Token.Keyword) && env$351.has(head$353.token.value) && env$351.get(head$353.token.value).name === resolve$168(head$353)) {
