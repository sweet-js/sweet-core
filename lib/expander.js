(function (root, factory) {
    ...
    function flattenModule(mod, context) {
        ...
        imports = mod.imports.reduce(function (acc, imp) {
        ...
        // actually available at runtime
        output = mod.body.reduce(function (acc, term) {
            if (term.isExport) {
    ...
    function compileModule(stx, options) {
        ...
        var compiledModules = flattened.imports.map(function (imp) {
            var modFullPath = resolvePath(unwrapSyntax(imp.from), mod);
            if (availableModules.has(modFullPath)) {
                var flattened$2 = flattenModule(availableModules.get(modFullPath), expanded.context);
                return {
                    path: modFullPath,
                    code: flattened$2.body
                };
            } else {
