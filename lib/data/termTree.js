...
function ClassDeclarationTerm(keyword, name, body) {
    this.keyword = keyword;
    this.name = name;
    this.body = body;
}
ClassDeclarationTerm.properties = ["keyword", "name", "body"];
ClassDeclarationTerm.create = function (keyword, name, body) {
    return new ClassDeclarationTerm(keyword, name, body);
};
inherit(StatementTerm, ClassDeclarationTerm, { isClassDeclarationTerm: true });
