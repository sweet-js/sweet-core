(function (root$90, factory$91) {
    ...
    function isWhiteSpace$116(ch$237) {
        return ch$237 === ' ' || ch$237 === '\t' || ch$237 === '\v' || ch$237 === '\f' || ch$237 === '\xa0' || ch$237.charCodeAt(0) >= 5760 && '\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\ufeff'.indexOf(ch$237) >= 0;
    }
    ...
    function parsePrimaryExpression$153() {
        ...
        if (type$338 === Token$94.Identifier) {
            var name$339 = extra$109.noresolve ? lex$135().token.value : expander$93.resolve(lex$135());
            return {
                type: Syntax$96.Identifier,
                name: name$339
            };
    ...
    function parseVariableIdentifier$181() {
        ...
        var name$384 = extra$109.noresolve ? stx$382 : expander$93.resolve(stx$382);
        return {
            type: Syntax$96.Identifier,
            name: name$384
        };
    ...
    function read$223(code$538) {
        ...
        return expander$93.tokensToSyntax(tokenTree$540);
    }
    function parse$224(code$542, nodeType$543, options$544) {
        var program$545, toString$546;
        tokenStream$108 = code$542;
        nodeType$543 = nodeType$543 || 'base';
        index$102 = 0;
        ...
        extra$109 = {};
        if (typeof options$544 !== 'undefined') {
            if (options$544.range || options$544.loc) {
                assert$110(false, 'Note range and loc is not currently implemented');
            }
            extra$109.range = typeof options$544.range === 'boolean' && options$544.range;
            extra$109.loc = typeof options$544.loc === 'boolean' && options$544.loc;
            extra$109.raw = typeof options$544.raw === 'boolean' && options$544.raw;
            if (typeof options$544.tokens === 'boolean' && options$544.tokens) {
                extra$109.tokens = [];
            }
            if (typeof options$544.comment === 'boolean' && options$544.comment) {
                extra$109.comments = [];
            }
            if (typeof options$544.tolerant === 'boolean' && options$544.tolerant) {
                extra$109.errors = [];
            }
            if (typeof options$544.noresolve === 'boolean' && options$544.noresolve) {
                extra$109.noresolve = options$544.noresolve;
            } else {
                extra$109.noresolve = false;
            }
        }
        patch$217();
        try {
            var classToParse$547 = {
                    'base': parseProgram$209,
                    'Program': parseProgram$209,
                    'expr': parseAssignmentExpression$177,
                    'ident': parsePrimaryExpression$153,
                    'lit': parsePrimaryExpression$153,
                    'LogicalANDExpression': parseLogicalANDExpression$174,
                    'PrimaryExpression': parsePrimaryExpression$153,
                    'VariableDeclarationList': parseVariableDeclarationList$183,
                    'StatementList': parseStatementList$179,
                    'SourceElements': function () {
                        state$107.inFunctionBody = true;
                        return parseSourceElements$208();
                    },
                    'FunctionDeclaration': parseFunctionDeclaration$205,
                    'FunctionExpression': parseFunctionExpression$206,
                    'ExpressionStatement': parseExpressionStatement$187,
                    'IfStatement': parseIfStatement$188,
                    'BreakStatement': parseBreakStatement$194,
                    'ContinueStatement': parseContinueStatement$193,
                    'WithStatement': parseWithStatement$196,
                    'SwitchStatement': parseSwitchStatement$198,
                    'ReturnStatement': parseReturnStatement$195,
                    'ThrowStatement': parseThrowStatement$199,
                    'TryStatement': parseTryStatement$201,
                    'WhileStatement': parseWhileStatement$190,
                    'ForStatement': parseForStatement$192,
                    'VariableDeclaration': parseVariableDeclaration$182,
                    'ArrayExpression': parseArrayInitialiser$148,
                    'ObjectExpression': parseObjectInitialiser$152,
                    'SequenceExpression': parseExpression$178,
                    'AssignmentExpression': parseAssignmentExpression$177,
                    'ConditionalExpression': parseConditionalExpression$176,
                    'NewExpression': parseNewExpression$159,
                    'CallExpression': parseLeftHandSideExpressionAllowCall$162,
                    'Block': parseBlock$180
                };
            if (classToParse$547[nodeType$543]) {
                program$545 = classToParse$547[nodeType$543]();
            } else {
                assert$110(false, 'unmatched parse class' + nodeType$543);
            }
            if (typeof extra$109.comments !== 'undefined') {
                program$545.comments = extra$109.comments;
            }
            if (typeof extra$109.tokens !== 'undefined') {
                program$545.tokens = tokenStream$108.slice(0, index$102);
            }
            if (typeof extra$109.errors !== 'undefined') {
                program$545.errors = extra$109.errors;
            }
        } catch (e$548) {
            throw e$548;
        } finally {
    ...
    exports$92.Syntax = function () {
        ...
        for (name$549 in Syntax$96) {
            if (Syntax$96.hasOwnProperty(name$549)) {
                types$550[name$549] = Syntax$96[name$549];
            }
        }
