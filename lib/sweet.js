var path = require('path'), fs = require('fs'), resolveSync = require('resolve/lib/sync'), gen = require('escodegen'), _ = require('underscore'), parser = require('./parser'), expander = require('./expander'), syn = require('./syntax'), to5 = require('6to5'), escope = require('escope');
