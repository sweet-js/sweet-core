...
exports.run = function () {
    ...
    if (watch$1201 && outfile$1200) {
        fs$1194.watch(infile$1199, function () {
            file$1204 = fs$1194.readFileSync(infile$1199, 'utf8');
            try {
                fs$1194.writeFileSync(outfile$1200, sweet$1196.compile(file$1204), 'utf8');
            } catch (e$1215) {
                console.log(e$1215);
            }
        });
        ...
        if (sourcemap$1203) {
            var result$1216 = sweet$1196.compileWithSourcemap(file$1204, infile$1199);
        ...
        console.log(sweet$1196.compile(file$1204));
    }
};