...
var VarBindingTransform = exports.VarBindingTransform = function VarBindingTransform(id_765) {
  _classCallCheck(this, VarBindingTransform);

  this.id = id_765;
};

var CompiletimeTransform = exports.CompiletimeTransform = function CompiletimeTransform(value_766) {
  _classCallCheck(this, CompiletimeTransform);

  this.value = value_766;
};
